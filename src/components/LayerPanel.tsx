  ...
  return (
    ...
    >
      ...
      <div className="p-2 border-t border-slate-700/80 bg-slate-800/80 flex items-center justify-between shrink-0">
        {(currentRole === 'Developer' || currentRole === 'RO Admin' || currentRole === 'RO Evaluator' || currentRole === 'RO Reviewer' || currentRole === 'IMO Admin' || currentRole === 'IMO Evaluator' || currentRole === 'IMO Reviewer') ? (
          <button
        ...
        {(currentRole === 'Developer' || currentRole === 'RO Admin' || currentRole === 'RO Evaluator' || currentRole === 'IMO Admin' || currentRole === 'IMO Evaluator') && (
