...
const ROLE_PERMISSIONS: RoleFeature[] = [
  ...
  },
  {
    ...
    description: 'Division Manager endorsement of IMO maintenance packages',
    developer: true,
    roEvaluator: false,
    roReviewer: false,
    roPreparer: false,
  ...
  },
  {
    ...
    description: 'RO Preparer, RO Reviewer, and RO Division Manager final approval',
    developer: true,
    roEvaluator: true,
    roReviewer: true,
    roPreparer: true,
  ...
  {
    feature: 'Developer Master Tools & User Management',
...
export const RoleMatrixModal: React.FC<RoleMatrixModalProps> = ({
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 backdrop-blur-xl animate-in fade-in ${
      ...
      <div className={`w-full max-w-4xl rounded-3xl border shadow-2xl overflow-hidden flex flex-col max-h-[88vh] transition-colors duration-300 ${
          ...
          <table className="w-full text-left text-xs border-collapse min-w-[700px]">
            <thead>
              <tr className={`border-b text-[10px] uppercase tracking-wider ${
                ...
                <th className="py-2.5 px-1.5 text-center text-rose-500">Dev</th>
                <th className="py-2.5 px-1.5 text-center text-red-500">RO Eval</th>
                <th className="py-2.5 px-1.5 text-center text-indigo-500">RO Rev</th>
                <th className="py-2.5 px-1.5 text-center text-purple-500">RO Prep</th>
                <th className="py-2.5 px-1.5 text-center text-amber-500">IMO Eval</th>
        ...
        <div className={`p-4 border-t flex items-center justify-between text-xs ${
          ...
          <div className="flex items-center gap-1.5 text-[11px]">
            ...
            <span>6-Tier Hierarchical Approval Workflow with Google Account SSO and IMO Jurisdiction.</span>
          </div>
          <button
            type="button"
            onClick={onClose}
