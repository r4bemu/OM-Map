...
export const Form691WeeklyReport: React.FC<Form691WeeklyReportProps> = ({
  ...
  const isRegionalRole = !userAssignedImo || userAssignedImo === 'All IMOs' || userAssignedImo === 'Regional Office IV-B' || ['Developer', 'RO Admin', 'RO Evaluator', 'RO Preparer'].includes(currentUser?.role || currentRole || '');
